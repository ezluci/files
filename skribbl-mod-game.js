!function(t, e, n, o, r) {
    function s(t, e, n, o) {
        ...
        a(t.find(".color"), r, 10, 48),
        a(t.find(".eyes"), s, 10, 48),
        a(t.find(".mouth"), i, 10, 48),
        e[3] >= 0 ? (t.find(".special").show(),
        a(t.find(".special"), e[3], 10, 80)) : t.find(".special").hide(),
        n ? t.find(".owner").show() : t.find(".owner").hide()
    }
    function i(t, e, n) {
    ...
    function u(t, e) {
        ...
        e >= J[t] && (e = 0),
        loginAvatarData[t] = e,
        s(n("#loginAvatar"), loginAvatarData, !1, 2),
        c())
    }
    function h() {
        n("#modalIdle").modal()
            ...
            if (it && it.drawingID == it.myID) {
                if (ht.drawCommands.length > 0) {
                    if (ht.drawCommands.length > 8) {
                        ...
                        at.emit("drawCommands", ht.drawCommands),
                        ht.drawCommands = t
                    } else
                        at.emit("drawCommands", ht.drawCommands),
                        ht.drawCommands = []
                ...
                ht.drawCommands.length > 0 && (ht.drawCommands = [])
    }
    function p() {
        setTimeout(function() {
            n("#rateDrawing").show()
    ...
    function w() {
        ...
        e.on("result", function(o) {
            o.code ? (n("#error-login").hide(),
            C(o.host, t)) : (n("#error-login").text(o.msg).show(),
            ut.goto("login")),
            e.close()
        })
    }
    ...
    function C(t, e) {
        ...
        at.on("connect", function() {
            ...
            at.on("lobbyKicked", function(t) {
                ...
                null != e && (it.chatAddMsg(null, e.name + " was kicked!", G),
                e.kicked = !0)
            }),
            ...
            at.on("lobbyPlayerConnected", function(t) {
                it.addPlayer(t),
                it.chatAddMsg(null, t.name + " joined.", j),
                ct.playSound("playerJoin")
            }),
            at.on("lobbyPlayerDisconnected", function(t) {
                var e = it.players.get(t);
                it.removePlayer(e),
                e.kicked || it.chatAddMsg(null, e.name + " left.", G),
                ct.playSound("playerLeave")
            }),
            at.on("lobbyPlayerGuessedWord", function(t) {
                var e = it.players.get(t);
                it.setPlayerGuessed(e),
                it.chatAddMsg(null, e.name + " guessed the word!", _),
                t == it.myID && it.chatDisable(),
                ct.playSound("playerGuessed")
            }),
            ...
            at.on("lobbyPlayerDrawing", function(t) {
                var e = it.players.get(t);
                it.setPlayerDrawing(e.id),
                it.chatAddMsg(null, e.name + " is drawing now!", O);
                var n = it.drawingID == it.myID;
                ht.setDrawing(n),
                n ? (f(),
                y()) : (p(),
                d()),
                ct.playSound("roundStart"),
                D(it.timeMax),
                U()
            }),
            at.on("lobbyOwnerChanged", function(t) {
                var e = it.players.get(t);
                it.setPlayerOwner(e),
                it.chatAddMsg(null, e.name + " is the owner now!", _)
            }),
            ...
            at.on("lobbyReveal", function(t) {
                A(),
                it.chatEnable(),
                it.chatAddMsg(null, "The word was '" + t.word + "'", _);
                ...
                it.setPlayerDrawing(-1),
                ht.setDrawing(!1),
                it.playersResetGuessedWord()
            }),
    ...
    function T(t, e, n) {
        if (it.checkDrawing() && (ht.updateMousePosition(t, e, n),
        ht.brush.down)) {
            var o = null;
    ...
    function I(t) {
        it.drawingID == it.myID ? (ht.drawCommands.push(t),
        ht.performDrawCommand(t)) : ht.addDrawCommandReceived(t)
    }
    function L(t) {
        if (pt)
            return lt.unshift(t),
    ...
    function R(t) {
        ...
        if ("endgame" == t.mode) {
            ...
            for (var i = 0; i < t.players.length; i++) {
                ...
                h.rank <= 3 ? y.append(l) : m.append(l),
                s(l, h.avatar, h.id == it.ownerID, h.rank <= 3 ? 2 : 1)
            }
        } else
            d.hide();
        o.show(),
    ...
    !function(t, e) {
                    ...
                    function s(t, e) {
                        ...
                        if (!n("json")) {
                            ...
                            y = function(t, e) {
                                ...
                                y = function(t, e) {
                                    var n, r, s = v.call(t) == w, i = !s && "function" != typeof t.constructor && a[typeof t.hasOwnProperty] && t.hasOwnProperty || d;
                                    for (n in t)
                                ...
                                var I, L, R = r.fromCharCode, U = {
                                    ...
                                    for (var t, e, n, o, r, s = L, i = s.length; I < i; )
                                            ...
                                            I++; I < i; )
                                                if ((r = s.charCodeAt(I)) < 32)
                                                    ...
                                                    case 117:
                                                        for (e = ++I,
                                                        n = I + 4; I < n; I++)
                                                            (r = s.charCodeAt(I)) >= 48 && r <= 57 || r >= 97 && r <= 102 || r >= 65 && r <= 70 || _();
                                                        t += R("0x" + s.slice(e, I));
                                                        break;
                                                    default:
                                                        _()
                                        ...
                                        default:
                                            ...
                                            r = s.charCodeAt(++I)),
                                            r >= 48 && r <= 57) {
                                                for (48 == r && (r = s.charCodeAt(I + 1)) >= 48 && r <= 57 && _(),
                                    ...
                                    "string" == typeof t) {
                                        ...
                                        if ("{" == t) {
                                            for (e = {}; "}" != (t = N()); n || (n = !0))
                                                n && ("," == t ? "}" == (t = N()) && _() : _()),
                                                "," != t && "string" == typeof t && "@" == (A ? t.charAt(0) : t[0]) && ":" == N() || _(),
                                                e[t.slice(1)] = O(N());
                                            return e
                                        }
                                        _()
        ...
        , function(t, e, n) {
            ...
            (function(t, r) {
                !function(s) {
                    ...
                    "object" == typeof r && r);
                    var y, m, g, v = String.fromCharCode, b = {
                        version: "1.0.0",
                        encode: h,
                        decode: f
                    };
        ...
        , function(t, n, o) {
            (function(n) {
                ...
                s.prototype.doPoll = function() {
                    ...
                    o ? o.parentNode.insertBefore(n, o) : (e.head || e.body).appendChild(n),
                    this.script = n,
                ...
                s.prototype.doWrite = function(t, n) {
                    ...
                    var s = this;
                    if (!this.form) {
                        var i, a = e.createElement("form"), c = e.createElement("textarea"), l = this.iframeId = "eio_iframe_" + this.index;
        ...
        , function(e, n, o) {
            (function(n) {
                ...
                var s, i = o(26), a = o(27), c = o(36), u = o(37), h = o(38), l = o(3)("engine.io-client:websocket"), p = n.WebSocket || n.MozWebSocket;
                if (void 0 === t)
                    try {
                        s = o(41)
                    } catch (t) {}
    ...
    var V = function(t, e) {
      ...
      , Z = function() {
        ...
        this.sounds = new Map,
        this.mute = !1,
        "true" === K.getItem("audioMute") && this.setMute(!0),
        t.addEventListener("load", this.load.bind(this), !1)
    };
    Z.prototype.setMute = function(t) {
        this.mute = t,
        this.mute ? n("#audio").css("background-image", "url(res/audio_off.gif") : n("#audio").css("background-image", "url(res/audio.gif"),
        K.setItem("audioMute", this.mute.toString())
    }
    ,
    ...
    Q.prototype.setDrawing = function(t) {
        t ? (this.brush.show(),
        n(".containerToolbar").show()) : (this.brush.hide(),
        n(".containerToolbar").hide())
    }
    ;
    var tt = function() {
        this.down = !1,
        ...
        this.brushCanvas = e.createElement("canvas"),
    ...
    tt.prototype.setDown = function(t) {
        ...
        n("#cursor .tool").css("top", this.down ? 0 : -8)
    }
    ,
    tt.prototype.setTool = function(t) {
        this.tool = t,
        n(".containerTools .tool").removeClass("toolActive"),
        n(".containerTools .tool[data-tool='" + t + "']").addClass("toolActive"),
    ...
    var et = function(t) {
        ...
        this.containerGame = n("#containerGamePlayers"),
        this.containerLobby = n("#containerLobbyPlayers"),
        this.chatClear(),
        this.containerGamePlayerClear(),
        this.containerLobbyPlayerClear();
        for (var e = 0; e < t.players.length; e++)
            this.addPlayer(t.players[e]);
        n("#invite").val("https://skribbl.io/?" + this.key),
        n("#screenLobby .lobbySettings .lobbyName").text(this.name),
    ...
    et.prototype.containerGamePlayerAdd = function(t) {
        ...
        this.containerGamePlayerUpdateScore(t),
        e.show(),
        s(e, t.avatar, t.id == this.ownerID, 1)
    }
    ,
    ...
    et.prototype.containerLobbyPlayerAdd = function(t) {
        ...
        s(e, t.avatar, t.id == this.ownerID, 2)
    }
    ,
    ...
    et.prototype.containerLobbyPlayersUpdateOwner = function() {
        ...
        n("#lobbySetRounds").prop("disabled", e),
        n("#lobbySetDrawTime").prop("disabled", e),
        n("#lobbySetCustomWords").prop("disabled", e),
        n("#lobbyCustomWordsExclusive").prop("disabled", e),
        n("#lobbySetLanguage").prop("disabled", e),
        n("#buttonLobbyPlay").prop("disabled", e)
    }
    ,
    ...
    ,
    et.prototype.chatDisable = function() {}
    ,
    et.prototype.chatEnable = function() {}
    ;
    var nt = function(t, e) {
        this.element = t,
        this.logo = e,
    ...
    ot.prototype.hideLogo = function() {
        n("#containerLogoBig").hide(),
        n("#containerLogoSmall").hide()
    }
    ,
    ...
    (st(rt, "skribbl-io.com") || st(rt, "skribblio.com") || st(rt, "skribbl-io.org") || st(rt, "skribblio.online")) && (t.top.location.href = "https://www.skribbl.io"),
    adplayer = null,
    ...
    ut.screens.game.onshow = function() {
        dt || (dt = !0,
        (adsbygoogle = t.adsbygoogle || []).push({}))
    }
    ,
    ...
    function() {
        for (var t = n("#logoAvatarDummy"), e = n("#logoAvatarContainer"), o = Math.round(8 * Math.random()), r = 0; r < 8; r++) {
            ...
            var a = [0, 0, 0, 0];
            a[0] = r,
            a[1] = Math.round(100 * Math.random()) % F,
            a[2] = Math.round(100 * Math.random()) % z,
    ...
    null != K.getItem("name") && n("#inputName").val(K.getItem("name")),
    n("#loginLanguage").change(function() {
        K.setItem("lang", n("#loginLanguage").val())
    }),
    null != K.getItem("lang") && n("#loginLanguage").val(K.getItem("lang")),
    loginAvatarData = function() {
        var t = K.getItem("avatar");
        return t ? t = JSON.parse(t) : (t = [Math.round(Math.random() * J[0]), Math.round(Math.random() * J[1]), Math.round(Math.random() * J[2]), -1],
        K.setItem("avatar", JSON.stringify(t))),
        t
    }(),
    n("#buttonAvatarCustomizerRandomize").on("click", function() {
        return loginAvatarData[0] = Math.floor(Math.random() * J[0]),
        loginAvatarData[1] = Math.floor(Math.random() * J[1]),
        loginAvatarData[2] = Math.floor(Math.random() * J[2]),
        c(),
        s(n("#loginAvatar"), loginAvatarData, !1, 2),
        !1
    }),
    s(n("#loginAvatar"), loginAvatarData, !1, 2),
    n("#loginAvatarArrowsLeft .avatarArrowLeft").on("click", function() {
    ...
    n(e).ready(function() {
        ...
        n(this).mousemove(e),
        n(this).keypress(e),
        n(this).on("mousedown", e),
        n(this).on("touchmove", e)
    }),
    setInterval(l, 50),
    n("#rateDrawing .thumbsUp").on("click", function() {
        at && at.emit("rateDrawing", 1),
        f()
    }),
    n("#rateDrawing .thumbsDown").on("click", function() {
        at && at.emit("rateDrawing", 0),
        f()
    }),
    f(),
    y(),
    n("#votekickCurrentplayer").on("click", m),
    n("#formLogin").submit(function(t) {
        t.preventDefault(),
        ft = !1,
        g()
    }),
    ...
    var yt = null
      ...
      , gt = 0;
    S(80),
    n("#lobbySetLanguage").on("change", function() {
    ...
    n("#buttonLobbyLeave").on("click", P),
    n("#buttonGameLeave").on("click", P),
    n("#buttonLobbyPlay").on("click", function() {
        at && it.myID == it.ownerID && at.emit("chat"/*old:"lobbyGameStart"*/, "idk whats that"/*old:n("#lobbySetCustomWords").val()*/)
    }),
    n("#formChat").submit(function(t) {
        var e = n("#inputChat")
          , o = e.val();
        return o && (at ? at.emit("chat", o) : it.chatAddMsg(it.players.get(it.myID), o, "#000"),
        e.val("")),
        !1
    }),
    ...
    n("#buttonLobbyCreate").on("click", function() {
        ...
        at.emit("lobbyCreate", t),
        n("#modalCreateLobby").modal("hide")
    }),
    ...
    n(e).keypress(function(t) {
        if (it && it.checkDrawing() && t !== r && t.key !== r)
    ...
    ht.canvas.on("mousedown", function(t) {
        ...
        t.button) {
        case 0:
            ht.brush.down || (ht.brush.setDown(!0),
            T(t.clientX, t.clientY, !0))
        }
    });
    var vt = null;
    ht.canvas.on("touchstart", function(t) {
        ...
        e.length > 0 && null == vt && (vt = e[0].identitfier,
        ht.brush.setDown(!0),
        T(e[0].clientX, e[0].clientY, !0))
    }),
